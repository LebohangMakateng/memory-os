...
export default async function OpportunitiesPage() {
  ...
  return <DashboardShell active="Opportunities">
    ...
    <section className="grid gap-6 lg:grid-cols-[.9fr_1.1fr]">
      <article className="rounded-2xl border border-[#dce4dd]/70 bg-white/70 backdrop-blur-xl p-7"><h2 className="font-serif text-2xl">New inbox item</h2><OpportunityForm /></article>
      <article className="rounded-2xl border border-[#dce4dd]/70 bg-white/70 backdrop-blur-xl p-7"><h2 className="font-serif text-2xl">Inbox</h2><OpportunityManager initiatives={overview.initiatives} opportunities={overview.opportunities} /></article>
    </section>
  </DashboardShell>;
}